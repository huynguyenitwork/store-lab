...
Copyright © 2018-2026 Martin Adámek. Built with Docusaurus.
============================================================
# https://mikro-orm.io/docs/6.6/quick-start
============================================================
[Skip to main content](https://mikro-orm.io/docs/6.6/quick-start#__docusaurus_skipToContent_fallback)
⭐️ If you like MikroORM, give it a star on [GitHub](https://github.com/mikro-orm/mikro-orm) and consider [sponsoring](https://github.com/sponsors/mikro-orm) its development! ⭐️
[ ![MikroORM](https://mikro-orm.io/img/logo.svg)![MikroORM](https://mikro-orm.io/img/logo-dark.svg) ](https://mikro-orm.io/)
[6.6](https://mikro-orm.io/docs/6.6/quick-start)
  * [Next](https://mikro-orm.io/docs/next/quick-start)
...
[latest: v7.1.3](https://mikro-orm.io/versions)[Discord](https://discord.gg/w8bjxFHS7X "Chat on Discord")[GitHub](https://github.com/mikro-orm/mikro-orm "View on GitHub")[Twitter](https://twitter.com/MikroORM "Twitter")
Search
  * [Quick Start](https://mikro-orm.io/docs/6.6/quick-start)
  * [Getting Started](https://mikro-orm.io/docs/6.6/guide)
    * [Chapter 1: First Entity](https://mikro-orm.io/docs/6.6/guide/first-entity)
    * [Chapter 2: Relationships](https://mikro-orm.io/docs/6.6/guide/relationships)
    * [Chapter 3: Project Setup](https://mikro-orm.io/docs/6.6/guide/project-setup)
    * [Chapter 4: Advanced](https://mikro-orm.io/docs/6.6/guide/advanced)
    * [Chapter 5: Type-safety](https://mikro-orm.io/docs/6.6/guide/type-safety)
  * [Fundamentals](https://mikro-orm.io/docs/6.6/fundamentals)
  * [Advanced Features](https://mikro-orm.io/docs/6.6/advanced)
  * [Recipes](https://mikro-orm.io/docs/6.6/recipes)
  * [Reference](https://mikro-orm.io/docs/6.6/reference)
  * [Example Integrations](https://mikro-orm.io/docs/6.6/examples)
  * [Upgrading](https://mikro-orm.io/docs/6.6/upgrading)
This is documentation for MikroORM **6.6** , which is no longer actively maintained.
For up-to-date documentation, see the **[latest version](https://mikro-orm.io/docs/quick-start)** (7.1).
Version: 6.6
On this page
# Quick Start
In this guide, you will learn how to quickly bootstrap a simple project using MikroORM. For a deeper dive, check out the [Getting Started guide](https://mikro-orm.io/docs/6.6/guide) which follows.
> If you prefer to take a peek at an existing project, there are [several example repositories](https://mikro-orm.io/docs/6.6/examples) available.
## Installation[​](https://mikro-orm.io/docs/6.6/quick-start#installation "Direct link to Installation")
First install the module via package manager of your choice. Do not forget to install the database driver as well:
  * npm
  * Yarn
  * pnpm
...
> 
```
You can read more about all the possible configuration options in [Advanced Configuration](https://mikro-orm.io/docs/6.6/configuration) section.
## Folder-based discovery[​](https://mikro-orm.io/docs/6.6/quick-start#folder-based-discovery "Direct link to Folder-based discovery")
...
```
If you are experiencing problems with folder based discovery, try using `mikro-orm debug` CLI command to check what paths are actually being used.
## Entity Discovery in TypeScript[​](https://mikro-orm.io/docs/6.6/quick-start#entity-discovery-in-typescript "Direct link to Entity Discovery in TypeScript")
...
```
Read more about the differences in [Metadata Providers section](https://mikro-orm.io/docs/6.6/metadata-providers).
```
import { MikroORM } from '@mikro-orm/postgresql';  
...
You can also use different the default [`ReflectMetadataProvider`](https://mikro-orm.io/docs/6.6/metadata-providers#reflectmetadataprovider) or even write custom one. Using [`EntitySchema`](https://mikro-orm.io/docs/6.6/entity-schema) is another way to define your entities and does not depend on the metadata providers at all.
```
import { MikroORM } from '@mikro-orm/postgresql';  
...
```
## Synchronous initialization[​](https://mikro-orm.io/docs/6.6/quick-start#synchronous-initialization "Direct link to Synchronous initialization")
...
## RequestContext helper[​](https://mikro-orm.io/docs/6.6/quick-start#requestcontext-helper "Direct link to RequestContext helper")
Now you will need to fork entity manager for each request so their [identity maps](https://mikro-orm.io/identity-map/) will not collide. To do so, use the `RequestContext` helper:
```
const app = express();  
...
```
> You should register this middleware as the last one just before request handlers and before any of your custom middleware that is using the ORM. There might be issues when you register it before request processing middleware like `queryParser` or `bodyParser`, so definitely register the context after them.
More info about `RequestContext` is described [here](https://mikro-orm.io/docs/6.6/identity-map#request-context).
## Entity definition[​](https://mikro-orm.io/docs/6.6/quick-start#entity-definition "Direct link to Entity definition")
...
```
More information can be found in [defining entities section](https://mikro-orm.io/docs/6.6/defining-entities) in docs.
## EntityManager[​](https://mikro-orm.io/docs/6.6/quick-start#entitymanager "Direct link to EntityManager")
...
```
Take a look at docs about [working with `EntityManager`](https://mikro-orm.io/docs/6.6/entity-manager).
## Setting up the Commandline Tool[​](https://mikro-orm.io/docs/6.6/quick-start#setting-up-the-commandline-tool "Direct link to Setting up the Commandline Tool")
MikroORM ships with a number of command line tools that are very helpful during development, like `SchemaGenerator` and `EntityGenerator`. You can call this command from the NPM binary directory or use `npx`:
```
# install the CLI package first!  
...
Your configuration file may export multiple configuration objects in an array. The different configurations must have a `contextName` in them. If no `contextName` is specified, it is treated as the name "default". You can use the `MIKRO_ORM_CONTEXT_NAME` environment variable or the `--contextName` command line option to pick a configuration with a particular `contextName` to use for the CLI. See [below](https://mikro-orm.io/docs/6.6/quick-start#configuration-file-structure) for details on the config object.
All available commands are listed in the CLI help:
```
$ npx mikro-orm  
...
```
To verify your setup, you can use `mikro-orm debug` command.
## Running MikroORM.init() without arguments[​](https://mikro-orm.io/docs/6.6/quick-start#running-mikroorminit-without-arguments "Direct link to Running MikroORM.init\(\) without arguments")
...
```
## Configuration file structure[​](https://mikro-orm.io/docs/6.6/quick-start#configuration-file-structure "Direct link to Configuration file structure")
Preferred way of creating to the configuration object is with the `defineConfig` helper. It will provide intellisense even in JavaScript files, without the need for type hints via jsdoc:
```
import { defineConfig } from '@mikro-orm/sqlite';  
...
```
which will let you run the "demo" database with "app" user whenever you do not specify `MIKRO_ORM_CONTEXT_NAME` or the `--contextName` option in CLI. Specifying "super" for the name will run the "demo" database with the "admin" user, specifying "use:example1" will load the "tenant_example1" database with the "app" user, and specifying "edit:example1" will load the "tenant_example1" database with the "admin" user.
[](https://github.com/mikro-orm/mikro-orm/edit/master/docs/versioned_docs/version-6.6/quick-start.md)
Last updated on **Mar 17, 2026** by **Martin Adámek**
[Next Getting Started Guide](https://mikro-orm.io/docs/6.6/guide)
  * [Installation](https://mikro-orm.io/docs/6.6/quick-start#installation)
  * [Folder-based discovery](https://mikro-orm.io/docs/6.6/quick-start#folder-based-discovery)
  * [Entity Discovery in TypeScript](https://mikro-orm.io/docs/6.6/quick-start#entity-discovery-in-typescript)
  * [Synchronous initialization](https://mikro-orm.io/docs/6.6/quick-start#synchronous-initialization)
  * [RequestContext helper](https://mikro-orm.io/docs/6.6/quick-start#requestcontext-helper)
  * [Entity definition](https://mikro-orm.io/docs/6.6/quick-start#entity-definition)
  * [EntityManager](https://mikro-orm.io/docs/6.6/quick-start#entitymanager)
  * [Setting up the Commandline Tool](https://mikro-orm.io/docs/6.6/quick-start#setting-up-the-commandline-tool)
  * [Running MikroORM.init() without arguments](https://mikro-orm.io/docs/6.6/quick-start#running-mikroorminit-without-arguments)
  * [Configuration file structure](https://mikro-orm.io/docs/6.6/quick-start#configuration-file-structure)
#### Docs
  * [Quick Start](https://mikro-orm.io/docs/quick-start)
  * [Getting Started](https://mikro-orm.io/docs/guide)
  * [Migration from v6 to v7](https://mikro-orm.io/docs/upgrading-v6-to-v7)
...
Copyright © 2018-2026 Martin Adámek. Built with Docusaurus.
============================================================
# https://mikro-orm.io/changelog
============================================================
[Skip to main content](https://mikro-orm.io/changelog#__docusaurus_skipToContent_fallback)
⭐️ If you like MikroORM, give it a star on [GitHub](https://github.com/mikro-orm/mikro-orm) and consider [sponsoring](https://github.com/sponsors/mikro-orm) its development! ⭐️
[![MikroORM](https://mikro-orm.io/img/logo.svg)](https://mikro-orm.io/)
[7.1](https://mikro-orm.io/docs/quick-start)
  * [Next](https://mikro-orm.io/docs/next/quick-start)
...
Search`Ctrl``K`
  * ▾v722
    * [v7.1.3](https://mikro-orm.io/changelog#v7.1.3)
    * [v7.1.2](https://mikro-orm.io/changelog#v7.1.2)
    * [v7.1.1](https://mikro-orm.io/changelog#v7.1.1)
    * [v7.1.0](https://mikro-orm.io/changelog#v7.1.0)
    * [v7.0.17](https://mikro-orm.io/changelog#v7.0.17)
    * [v7.0.16](https://mikro-orm.io/changelog#v7.0.16)
    * [v7.0.15](https://mikro-orm.io/changelog#v7.0.15)
    * [v7.0.14](https://mikro-orm.io/changelog#v7.0.14)
    * [v7.0.13](https://mikro-orm.io/changelog#v7.0.13)
    * [v7.0.12](https://mikro-orm.io/changelog#v7.0.12)
    * [v7.0.11](https://mikro-orm.io/changelog#v7.0.11)
    * [v7.0.10](https://mikro-orm.io/changelog#v7.0.10)
    * [v7.0.9](https://mikro-orm.io/changelog#v7.0.9)
    * [v7.0.8](https://mikro-orm.io/changelog#v7.0.8)
    * [v7.0.7](https://mikro-orm.io/changelog#v7.0.7)
    * [v7.0.6](https://mikro-orm.io/changelog#v7.0.6)
    * [v7.0.5](https://mikro-orm.io/changelog#v7.0.5)
    * [v7.0.4](https://mikro-orm.io/changelog#v7.0.4)
    * [v7.0.3](https://mikro-orm.io/changelog#v7.0.3)
    * [v7.0.2](https://mikro-orm.io/changelog#v7.0.2)
    * [v7.0.1](https://mikro-orm.io/changelog#v7.0.1)
    * [v7.0.0](https://mikro-orm.io/changelog#v7.0.0)
  * ▸v687
  * ▸v578
  * ▸v435
  * ▸v37
# Changelog
Release notes are sourced from [GitHub Releases](https://github.com/mikro-orm/mikro-orm/releases) across the entire monorepo.
## v7
###  [v7.1.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.1.3)2026-05-31
...
### Features
  * **core:** support onReserveConnection across SQL drivers ([#7815](https://github.com/mikro-orm/mikro-orm/issues/7815)) ([166c966](https://github.com/mikro-orm/mikro-orm/commit/166c9669c4668374d0a726e03a57390e3897000c))
...
###  [v7.1.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.1.2)2026-05-29
...
###  [v7.1.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.1.1)2026-05-22
...
###  [v7.1.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.1.0)2026-05-20
#  [7.1.0](https://github.com/mikro-orm/mikro-orm/compare/v7.0.17...v7.1.0) (2026-05-20)
### Bug Fixes
  * **core:** coerce ISO date strings to `Date` in `em.assign()` ([#7740](https://github.com/mikro-orm/mikro-orm/issues/7740)) ([0940a5f](https://github.com/mikro-orm/mikro-orm/commit/0940a5f32c57a7ad2287b11b10147a1f83338df0)), closes [#7737](https://github.com/mikro-orm/mikro-orm/issues/7737)
  * **core:** skip M:N inverse scrub for STI siblings that can't reference the entity ([#7759](https://github.com/mikro-orm/mikro-orm/issues/7759)) ([6971c8a](https://github.com/mikro-orm/mikro-orm/commit/6971c8a171ace363518cffd175b526ffe4766548))
  * **core:** treat inlined embeddables as loaded when their leaves are ([#7758](https://github.com/mikro-orm/mikro-orm/issues/7758)) ([e89dab0](https://github.com/mikro-orm/mikro-orm/commit/e89dab0d9f84de36b249295bd3c580589f8237ab))
  * **mongo:** clean up inlined pivot on em.remove when owning side is populated ([#7755](https://github.com/mikro-orm/mikro-orm/issues/7755)) ([4c5f03a](https://github.com/mikro-orm/mikro-orm/commit/4c5f03a82ed2662b3510049e1d2db30ee26124ec)), closes [#7752](https://github.com/mikro-orm/mikro-orm/issues/7752)
  * **mongo:** create collections before ensuring indexes in `create()` ([#7745](https://github.com/mikro-orm/mikro-orm/issues/7745)) ([531bc6b](https://github.com/mikro-orm/mikro-orm/commit/531bc6b4182902ce7daea55def235cc0fe5520f8))
  * **mongo:** throw on em.remove of inlined-pivot M:N target with uninitialized owning side ([#7752](https://github.com/mikro-orm/mikro-orm/issues/7752)) ([231f84c](https://github.com/mikro-orm/mikro-orm/commit/231f84cd6f4f29cf229259cbfba861dad0c9858b)), closes [#7750](https://github.com/mikro-orm/mikro-orm/issues/7750)
...
### Features
  ...
  * **core:** accept enum references directly in `items` ([#7606](https://github.com/mikro-orm/mikro-orm/issues/7606)) ([3d67892](https://github.com/mikro-orm/mikro-orm/commit/3d67892cbb763776e3e00f43d18161839a4ccdab))
  ...
  * **core:** add `fields` whitelist option to `serialize()` ([#7517](https://github.com/mikro-orm/mikro-orm/issues/7517)) ([6ea6d64](https://github.com/mikro-orm/mikro-orm/commit/6ea6d64a1aad6036f87765b857fb784397d3a1e9)), closes [#7507](https://github.com/mikro-orm/mikro-orm/issues/7507)
  * **core:** add `initNullableProperties` config option ([#7554](https://github.com/mikro-orm/mikro-orm/issues/7554)) ([03a3122](https://github.com/mikro-orm/mikro-orm/commit/03a3122129aee5ade3a5d74bc61b629eb0905063)), closes [#7551](https://github.com/mikro-orm/mikro-orm/issues/7551)
  ...
  * **core:** add dataloader support for `Collection.loadCount()` ([#7373](https://github.com/mikro-orm/mikro-orm/issues/7373)) ([120189c](https://github.com/mikro-orm/mikro-orm/commit/120189cfd413888c368312b9558b58688bb49693)), closes [#7372](https://github.com/mikro-orm/mikro-orm/issues/7372) [#6425](https://github.com/mikro-orm/mikro-orm/issues/6425)
  ...
  * **core:** auto-generated classes inherit from parent with defineEntity extends ([#7404](https://github.com/mikro-orm/mikro-orm/issues/7404)) ([94450ef](https://github.com/mikro-orm/mikro-orm/commit/94450eff3f52c36c08c42ca64a6981e8a4ceea44))
  ...
  * **core:** support `array` option on scalar properties ([#7378](https://github.com/mikro-orm/mikro-orm/issues/7378)) ([b54b756](https://github.com/mikro-orm/mikro-orm/commit/b54b7567fda1a38636869d43c2e788777c7c9862)), closes [#7363](https://github.com/mikro-orm/mikro-orm/issues/7363)
...
###  [v7.0.17](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.17)2026-05-17
...
###  [v7.0.16](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.16)2026-05-14
...
###  [v7.0.15](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.15)2026-05-09
...
###  [v7.0.14](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.14)2026-05-04
...
###  [v7.0.13](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.13)2026-04-27
...
### Bug Fixes
  ...
  * **sql:** stabilize migration snapshot serialization ([#7608](https://github.com/mikro-orm/mikro-orm/issues/7608)) ([caec061](https://github.com/mikro-orm/mikro-orm/commit/caec0616cebf111dd32e89d5a0c798ec840d3c36)), closes [#7607](https://github.com/mikro-orm/mikro-orm/issues/7607) [#7610](https://github.com/mikro-orm/mikro-orm/issues/7610) [#7607](https://github.com/mikro-orm/mikro-orm/issues/7607) [#7610](https://github.com/mikro-orm/mikro-orm/issues/7610)
###  [v7.0.12](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.12)2026-04-23
...
###  [v7.0.11](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.11)2026-04-16
...
### Bug Fixes
  ...
  * **core:** unwrap IType serialized type for scalar-based properties in EntityDTO ([#7549](https://github.com/mikro-orm/mikro-orm/issues/7549)) ([42e4675](https://github.com/mikro-orm/mikro-orm/commit/42e467519bebdfa16193d53846f8d195e92f36b1))
  ...
  * **migrations:** skip database connection in `create()` and `getPending()` when snapshot exists ([#7568](https://github.com/mikro-orm/mikro-orm/issues/7568)) ([4bf6ed5](https://github.com/mikro-orm/mikro-orm/commit/4bf6ed55f2c49e78a1d3b710852bf345829eaac3)), closes [#7493](https://github.com/mikro-orm/mikro-orm/issues/7493)
...
###  [v7.0.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.10)2026-04-10
...
###  [v7.0.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.9)2026-04-06
...
###  [v7.0.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.8)2026-04-01
...
###  [v7.0.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.7)2026-03-31
...
###  [v7.0.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.6)2026-03-26
...
###  [v7.0.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.5)2026-03-23
...
### Bug Fixes
  ...
  * **core:** handle Bun path lookup for native ES decorators ([#7382](https://github.com/mikro-orm/mikro-orm/issues/7382)) ([9916203](https://github.com/mikro-orm/mikro-orm/commit/991620353ae2892e196078f9c3795c22ddf59b13)), closes [#7381](https://github.com/mikro-orm/mikro-orm/issues/7381)
...
###  [v7.0.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.4)2026-03-20
...
###  [v7.0.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.3)2026-03-18
...
###  [v7.0.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.2)2026-03-14
...
###  [v7.0.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.1)2026-03-11
...
###  [v7.0.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v7.0.0)2026-03-11
...
## v6
###  [v6.6.14](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.14)2026-05-04
...
### Bug Fixes
  ...
  * **postgres:** schema-qualify generated drop index statements ([#7662](https://github.com/mikro-orm/mikro-orm/issues/7662)) ([d588a02](https://github.com/mikro-orm/mikro-orm/commit/d588a02daec66adb53e1ccbdd4c29598f526f679)), closes [#7603](https://github.com/mikro-orm/mikro-orm/issues/7603)
  * **postgres:** treat timetz / time with time zone as aliases in schema diff ([#7663](https://github.com/mikro-orm/mikro-orm/issues/7663)) ([686d2f8](https://github.com/mikro-orm/mikro-orm/commit/686d2f861d33aa7e309033ec6b2e89b53766636b)), closes [#7618](https://github.com/mikro-orm/mikro-orm/issues/7618)
###  [v6.6.13](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.13)2026-04-10
...
###  [v6.6.12](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.12)2026-04-01
...
###  [v6.6.11](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.11)2026-03-31
...
###  [v6.6.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.10)2026-03-26
...
### Bug Fixes
  ...
  * **schema:** escape single quotes in enum CHECK constraints ([#7397](https://github.com/mikro-orm/mikro-orm/issues/7397)) ([db19731](https://github.com/mikro-orm/mikro-orm/commit/db197313fe1bcfd2050b808eab9c39a334e45b68)), closes [#7396](https://github.com/mikro-orm/mikro-orm/issues/7396) [#7395](https://github.com/mikro-orm/mikro-orm/issues/7395)
###  [v6.6.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.9)2026-03-05
...
###  [v6.6.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.8)2026-03-01
...
###  [v6.6.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.7)2026-02-15
...
###  [v6.6.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.6)2026-01-30
...
###  [v6.6.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.5)2026-01-21
...
###  [v6.6.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.4)2026-01-14
...
###  [v6.6.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.3)2026-01-04
...
###  [v6.6.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.2)2025-12-07
...
###  [v6.6.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.1)2025-11-25
...
###  [v6.6.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.6.0)2025-11-11
...
###  [v6.5.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.9)2025-10-23
...
### Performance Improvements
  * **core:** improve performance of `defineEntity` ([#6922](https://github.com/mikro-orm/mikro-orm/issues/6922)) ([db6b10a](https://github.com/mikro-orm/mikro-orm/pull/6922/commits/db6b10a01aa2f60c8bf38ce8192e02a6984e769e))
###  [v6.5.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.8)2025-10-13
...
### Bug Fixes
  ...
  * **core:** support class-based entity definitions with `defineEntity` ([#6920](https://github.com/mikro-orm/mikro-orm/issues/6920)) ([aa7295e](https://github.com/mikro-orm/mikro-orm/commit/aa7295e423da79d6b385b59fea9fbb75d20e933d)), closes [6865](https://github.com//github.com/mikro-orm/mikro-orm/discussions/6865/issues/discussioncomment-14465227)
...
###  [v6.5.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.7)2025-10-06
...
### Features
  * **mongo:** implement optimistic locking support for version properties ([#6887](https://github.com/mikro-orm/mikro-orm/issues/6887)) ([591fb43](https://github.com/mikro-orm/mikro-orm/commit/591fb43cf9ef420015e742ef735b81e7b218a062)), closes [#3612](https://github.com/mikro-orm/mikro-orm/issues/3612)
### Performance Improvements
  * optimize merging of entities to upper context after `em.transactional` ([36bdc43](https://github.com/mikro-orm/mikro-orm/commit/36bdc43772d06635f0db94296ad47241e40aa63d), [b29e88c](https://github.com/mikro-orm/mikro-orm/commit/b29e88cbd527ee8e2c08cb5d32199dd9c9615d8f), [b7751d5](https://github.com/mikro-orm/mikro-orm/commit/b7751d55abf5bd2ca421545dc81d8cab33e38b12), [940214d](https://github.com/mikro-orm/mikro-orm/commit/940214dca9180cc95d293a33774f1d6fd6e5d0d5)), closes [#6905](https://github.com/mikro-orm/mikro-orm/issues/6905), [#6890](https://github.com/mikro-orm/mikro-orm/issues/6890)
###  [v6.5.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.6)2025-09-25
...
### Bug Fixes
  ...
  * **core:** enhance type of bigint, array, decimal properties when using `defineEntity` helper ([#6873](https://github.com/mikro-orm/mikro-orm/issues/6873)) ([42e7df1](https://github.com/mikro-orm/mikro-orm/commit/42e7df147dc1134cd9a52e8d953094df1d41b22a))
...
###  [v6.5.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.5)2025-09-21
...
###  [v6.5.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.4)2025-09-17
...
###  [v6.5.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.3)2025-09-13
...
###  [v6.5.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.2)2025-09-02
...
###  [v6.5.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.1)2025-08-27
...
###  [v6.5.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.5.0)2025-08-27
...
###  [v6.4.16](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.16)2025-05-30
...
###  [v6.4.15](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.15)2025-05-09
...
###  [v6.4.14](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.14)2025-05-05
...
###  [v6.4.13](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.13)2025-04-12
...
###  [v6.4.12](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.12)2025-04-06
...
###  [v6.4.11](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.11)2025-03-21
...
###  [v6.4.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.10)2025-03-16
...
###  [v6.4.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.9)2025-03-07
...
### Bug Fixes
  ...
  * **core:** skip TS support detection via `require.extensions` ([#6488](https://github.com/mikro-orm/mikro-orm/issues/6488)) ([3efdcd0](https://github.com/mikro-orm/mikro-orm/commit/3efdcd0a00d038b2eb24a668329f4b1cea46b2a2))
...
###  [v6.4.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.8)2025-03-06
...
###  [v6.4.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.7)2025-02-22
...
### Features
  ...
  * **core:** improve typings for `@Entity`, `@Index` and `@Unique` decorators ([#6416](https://github.com/mikro-orm/mikro-orm/issues/6416)) ([833a640](https://github.com/mikro-orm/mikro-orm/commit/833a6403ca393c341fca8e6207652d063fdb0677))
### Performance Improvements
...
###  [v6.4.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.6)2025-02-12
...
###  [v6.4.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.5)2025-01-30
...
###  [v6.4.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.4)2025-01-23
...
###  [v6.4.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.3)2025-01-08
...
###  [v6.4.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.2)2024-12-22
...
###  [v6.4.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.1)2024-12-08
...
###  [v6.4.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.4.0)2024-11-11
...
###  [v6.3.13](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.13)2024-10-06
...
###  [v6.3.12](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.12)2024-10-01
...
### Bug Fixes
  ...
  * **mongo:** fix persisting objects like `ObjectID` in JSON properties ([#6091](https://github.com/mikro-orm/mikro-orm/issues/6091)) ([c28f06f](https://github.com/mikro-orm/mikro-orm/commit/c28f06fbe85b00b0dc03fd3c2c066f000fe81a90)), closes (#6050)
...
###  [v6.3.11](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.11)2024-09-26
...
###  [v6.3.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.10)2024-09-15
...
###  [v6.3.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.9)2024-09-09
...
###  [v6.3.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.8)2024-09-04
...
###  [v6.3.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.7)2024-08-28
...
###  [v6.3.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.6)2024-08-14
...
###  [v6.3.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.5)2024-08-11
...
###  [v6.3.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.4)2024-08-06
...
###  [v6.3.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.3)2024-08-03
...
###  [v6.3.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.2)2024-08-01
...
###  [v6.3.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.1)2024-07-25
...
###  [v6.3.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.3.0)2024-07-18
...
###  [v6.2.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.9)2024-05-31
...
###  [v6.2.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.8)2024-05-21
...
###  [v6.2.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.7)2024-05-18
...
###  [v6.2.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.6)2024-05-14
...
###  [v6.2.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.5)2024-05-05
...
###  [v6.2.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.4)2024-05-02
...
###  [v6.2.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.3)2024-04-24
...
###  [v6.2.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.2)2024-04-20
...
###  [v6.2.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.1)2024-04-12
...
###  [v6.2.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.2.0)2024-04-09
...
###  [v6.1.12](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.12)2024-03-24
...
###  [v6.1.11](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.11)2024-03-18
...
###  [v6.1.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.10)2024-03-14
...
### Performance Improvements
  * **core:** disable change tracking on scalars when `flushMode` is not `auto` ([fc30bfe](https://github.com/mikro-orm/mikro-orm/commit/fc30bfe13888293a9ac9b91d8bbc874eb3c98e31))
###  [v6.1.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.9)2024-03-10
...
###  [v6.1.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.8)2024-03-06
...
###  [v6.1.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.7)2024-03-04
...
###  [v6.1.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.6)2024-02-28
...
###  [v6.1.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.5)2024-02-21
...
###  [v6.1.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.4)2024-02-16
...
###  [v6.1.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.3)2024-02-13
...
###  [v6.1.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.2)2024-02-11
...
###  [v6.1.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.1)2024-02-10
...
### Bug Fixes
  ...
  * **postgres:** fix parsing of date properties inside object embeddables ([760ec77](https://github.com/mikro-orm/mikro-orm/commit/760ec77b1f852103f878998bb2c76edce1fb5c77)), closes [#5216](https://github.com/mikro-orm/mikro-orm/issues/5216)
...
###  [v6.1.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.1.0)2024-02-04
...
###  [v6.0.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.7)2024-01-30
...
###  [v6.0.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.6)2024-01-29
...
###  [v6.0.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.5)2024-01-18
...
###  [v6.0.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.4)2024-01-15
...
###  [v6.0.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.3)2024-01-13
...
###  [v6.0.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.2)2024-01-09
...
### Bug Fixes
  ...
  * **core:** allow calling `load()` on references and collections of not managed entities ([3b94bf9](https://github.com/mikro-orm/mikro-orm/commit/3b94bf957243e8ded787c853915c84cfc94832d7)), closes [#5082](https://github.com/mikro-orm/mikro-orm/issues/5082)
...
### Features
  * **core:** add `wrap(entity).isManaged()` ([5931649](https://github.com/mikro-orm/mikro-orm/commit/59316495304199b93685324d0077b22fec502fb6))
...
###  [v6.0.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.1)2024-01-08
##  [6.0.1](https://github.com/mikro-orm/mikro-orm/compare/v6.0.0...v6.0.1) (2024-01-08)
### Bug Fixes
  * **core:** adjust peer dependencies versions
###  [v6.0.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v6.0.0)2024-01-08
...
## v5
###  [v5.9.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.8)2024-02-04
...
###  [v5.9.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.7)2023-12-30
...
###  [v5.9.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.6)2023-12-21
...
###  [v5.9.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.5)2023-12-15
...
###  [v5.9.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.4)2023-11-17
...
###  [v5.9.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.3)2023-11-06
...
###  [v5.9.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.2)2023-11-02
...
###  [v5.9.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.1)2023-10-31
...
###  [v5.9.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.9.0)2023-10-24
...
###  [v5.8.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.10)2023-10-18
...
###  [v5.8.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.9)2023-10-15
...
###  [v5.8.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.8)2023-10-11
...
###  [v5.8.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.7)2023-10-05
...
###  [v5.8.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.6)2023-10-02
...
###  [v5.8.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.5)2023-09-30
...
### Bug Fixes
  ...
  * **core:** map virtual properties that shadow a regular property from joined results ([d0b3698](https://github.com/mikro-orm/mikro-orm/commit/d0b3698eebbbd2a74809b70f7aa37c82cee0359e)), closes [#3820](https://github.com/mikro-orm/mikro-orm/issues/3820)
...
###  [v5.8.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.4)2023-09-27
...
###  [v5.8.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.3)2023-09-24
...
###  [v5.8.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.2)2023-09-20
...
###  [v5.8.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.1)2023-09-12
...
###  [v5.8.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.8.0)2023-09-10
...
###  [v5.7.14](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.14)2023-07-27
...
###  [v5.7.13](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.13)2023-07-16
...
###  [v5.7.12](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.12)2023-06-10
...
###  [v5.7.11](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.11)2023-06-01
...
###  [v5.7.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.10)2023-05-23
...
###  [v5.7.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.9)2023-05-22
...
###  [v5.7.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.8)2023-05-21
...
###  [v5.7.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.7)2023-05-14
...
###  [v5.7.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.6)2023-05-13
...
###  [v5.7.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.5)2023-05-09
...
###  [v5.7.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.4)2023-05-01
...
###  [v5.7.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.3)2023-04-28
...
###  [v5.7.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.2)2023-04-25
...
###  [v5.7.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.1)2023-04-25
...
###  [v5.7.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.7.0)2023-04-23
...
### Performance Improvements
  * **core:** fix eager loading of multiple properties causing cycles ([ecbecfc](https://github.com/mikro-orm/mikro-orm/commit/ecbecfc9b46ea7402024e7fd31e3f818b361d860)), closes [#4213](https://github.com/mikro-orm/mikro-orm/issues/4213)
###  [v5.6.16](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.16)2023-04-04
...
###  [v5.6.15](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.15)2023-03-18
...
###  [v5.6.14](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.14)2023-03-12
...
###  [v5.6.13](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.13)2023-03-01
...
###  [v5.6.12](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.12)2023-02-26
...
###  [v5.6.11](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.11)2023-02-17
...
###  [v5.6.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.10)2023-02-17
...
###  [v5.6.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.9)2023-02-10
...
###  [v5.6.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.8)2023-01-25
...
###  [v5.6.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.7)2023-01-13
...
###  [v5.6.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.6)2023-01-10
...
### Bug Fixes
  ...
  * **core:** do not allow functions and symbols in `FilterQuery` ([85b1fc1](https://github.com/mikro-orm/mikro-orm/commit/85b1fc13399a04539f8dcfa31ef12aaef540aa95)), closes [#3928](https://github.com/mikro-orm/mikro-orm/discussions/3928)
###  [v5.6.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.5)2023-01-09
...
###  [v5.6.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.4)2023-01-04
...
###  [v5.6.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.3)2022-12-28
...
###  [v5.6.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.2)2022-12-25
...
###  [v5.6.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.1)2022-12-20
...
###  [v5.6.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.6.0)2022-12-09
...
### Features
  * **cli:** added option to generate cache via ts-node ([#3796](https://github.com/mikro-orm/mikro-orm/issues/3796)) ([268bd68](https://github.com/mikro-orm/mikro-orm/commit/268bd681993edd5a8fd754658a96c26d5c970350)), closes <https://github.com/mikro-orm/mikro-orm/discussions/3795>
...
###  [v5.5.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.5.3)2022-11-10
...
###  [v5.5.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.5.2)2022-11-07
...
###  [v5.5.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.5.1)2022-11-05
...
###  [v5.5.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.5.0)2022-10-23
...
###  [v5.4.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.4.2)2022-09-12
...
###  [v5.4.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.4.1)2022-09-08
...
###  [v5.4.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.4.0)2022-09-01
...
###  [v5.3.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.3.1)2022-08-04
...
###  [v5.3.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.3.0)2022-08-01
...
###  [v5.2.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.2.4)2022-07-25
...
###  [v5.2.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.2.3)2022-07-08
...
### Bug Fixes
  ...
  * **mongo:** fix ensuring indexes on failure ([#3276](https://github.com/mikro-orm/mikro-orm/issues/3276)) ([da20e1f](https://github.com/mikro-orm/mikro-orm/commit/da20e1f74329f6fe6913e4a483bde7e71bfec17b))
###  [v5.2.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.2.2)2022-07-03
...
###  [v5.2.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.2.1)2022-06-21
...
###  [v5.2.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.2.0)2022-06-10
...
###  [v5.1.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.1.5)2022-05-29
...
###  [v5.1.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.1.4)2022-05-19
...
###  [v5.1.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.1.3)2022-04-27
...
###  [v5.1.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.1.2)2022-04-10
...
###  [v5.1.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.1.1)2022-03-20
...
###  [v5.1.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.1.0)2022-03-13
...
###  [v5.0.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.0.5)2022-02-27
...
###  [v5.0.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.0.4)2022-02-22
...
###  [v5.0.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.0.3)2022-02-20
...
###  [v5.0.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.0.2)2022-02-16
...
###  [v5.0.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.0.1)2022-02-13
...
###  [v5.0.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v5.0.0)2022-02-06
...
### BREAKING CHANGES
Please see the [upgrading guide](https://mikro-orm.io/docs/docs/upgrading-v4-to-v5.md).
## v4
###  [v4.5.10](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.10)2021-12-26
...
###  [v4.5.9](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.9)2021-08-24
...
###  [v4.5.8](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.8)2021-08-24
...
###  [v4.5.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.7)2021-06-30
...
###  [v4.5.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.6)2021-06-06
...
###  [v4.5.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.5)2021-05-17
...
###  [v4.5.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.4)2021-04-26
...
###  [v4.5.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.3)2021-04-09
...
###  [v4.5.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.2)2021-04-06
...
###  [v4.5.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.1)2021-03-27
...
###  [v4.5.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.5.0)2021-03-21
...
###  [v4.4.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.4.4)2021-02-21
...
###  [v4.4.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.4.3)2021-02-14
...
###  [v4.4.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.4.2)2021-02-04
...
###  [v4.4.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.4.1)2021-02-01
...
###  [v4.4.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.4.0)2021-01-24
...
###  [v4.3.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.3.4)2020-12-11
...
###  [v4.3.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.3.3)2020-12-04
...
###  [v4.3.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.3.2)2020-11-24
...
###  [v4.3.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.3.1)2020-11-20
...
###  [v4.3.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.3.0)2020-11-13
...
###  [v4.2.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.2.3)2020-10-24
...
###  [v4.2.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.2.2)2020-10-22
...
###  [v4.2.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.2.1)2020-10-20
...
###  [v4.2.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.2.0)2020-10-18
...
###  [v4.1.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.1.1)2020-10-14
...
###  [v4.1.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.1.0)2020-10-12
...
###  [v4.0.7](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.7)2020-09-24
...
###  [v4.0.6](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.6)2020-09-22
...
###  [v4.0.5](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.5)2020-09-21
...
###  [v4.0.4](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.4)2020-09-19
...
###  [v4.0.3](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.3)2020-09-15
...
###  [MikroORM 4.0.2](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.2)2020-09-11
### Bug Fixes
...
###  [MikroORM 4.0.1](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.1)2020-09-10
### Bug Fixes
...
###  [MikroORM 4.0.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v4.0.0)2020-09-08
### Bug Fixes
...
### BREAKING CHANGES
Please see the [upgrading guide](https://mikro-orm.io/docs/docs/upgrading-v3-to-v4.md).
## v3
###  [MikroORM 3.6.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v3.6.0)2020-04-01
### Bug Fixes
...
###  [MikroORM 3.5.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v3.5.0)2020-03-21
### Bug Fixes
...
###  [MikroORM 3.4.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v3.4.0)2020-03-09
### Features
...
###  [MikroORM 3.3.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v3.3.0)2020-02-25
### Bug Fixes
...
###  [MikroORM 3.2.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v3.2.0)2020-02-19
### Bug Fixes
...
###  [MikroORM 3.1.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v3.1.0)2020-02-19
### Bug Fixes
...
###  [MikroORM 3.0.0](https://github.com/mikro-orm/mikro-orm/releases/tag/v3.0.0)2020-01-15
### Bug Fixes
...
### BREAKING CHANGES
Please see the [upgrading guide](https://mikro-orm.io/docs/docs/upgrading-v2-to-v3.md).
#### Docs
  * [Quick Start](https://mikro-orm.io/docs/quick-start)
  * [Getting Started](https://mikro-orm.io/docs/guide)
  * [Migration from v6 to v7](https://mikro-orm.io/docs/upgrading-v6-to-v7)
...
Copyright © 2018-2026 Martin Adámek. Built with Docusaurus.
============================================================
# https://mikro-orm.io/docs/7.0/quick-start
============================================================
[Skip to main content](https://mikro-orm.io/docs/7.0/quick-start#__docusaurus_skipToContent_fallback)
⭐️ If you like MikroORM, give it a star on [GitHub](https://github.com/mikro-orm/mikro-orm) and consider [sponsoring](https://github.com/sponsors/mikro-orm) its development! ⭐️
[![MikroORM](https://mikro-orm.io/img/logo.svg)](https://mikro-orm.io/)
[7.0](https://mikro-orm.io/docs/7.0/quick-start)
  * [Next](https://mikro-orm.io/docs/next/quick-start)
...
[latest: v7.1.3](https://mikro-orm.io/versions)[Discord](https://discord.gg/w8bjxFHS7X "Chat on Discord")[GitHub](https://github.com/mikro-orm/mikro-orm "View on GitHub")[Twitter](https://twitter.com/MikroORM "Twitter")
Search`Ctrl``K`
  * [Quick Start](https://mikro-orm.io/docs/7.0/quick-start)
  * [Getting Started](https://mikro-orm.io/docs/7.0/guide)
    * [Chapter 1: First Entity](https://mikro-orm.io/docs/7.0/guide/first-entity)
    * [Chapter 2: Relationships](https://mikro-orm.io/docs/7.0/guide/relationships)
    * [Chapter 3: Project Setup](https://mikro-orm.io/docs/7.0/guide/project-setup)
    * [Chapter 4: Advanced](https://mikro-orm.io/docs/7.0/guide/advanced)
    * [Chapter 5: Type-safety](https://mikro-orm.io/docs/7.0/guide/type-safety)
  * [Core Concepts](https://mikro-orm.io/docs/7.0/core-concepts)
  * [Modeling](https://mikro-orm.io/docs/7.0/modeling)
  * [Querying](https://mikro-orm.io/docs/7.0/querying)
  * [Schema & Database](https://mikro-orm.io/docs/7.0/schema-database)
  * [Advanced](https://mikro-orm.io/docs/7.0/advanced)
  * [Configuration](https://mikro-orm.io/docs/7.0/configuration)
  * [Integrations](https://mikro-orm.io/docs/7.0/integrations)
  * [Recipes](https://mikro-orm.io/docs/7.0/recipes)
  * [Reference](https://mikro-orm.io/docs/7.0/reference)
  * [Example Integrations](https://mikro-orm.io/docs/7.0/examples)
  * [Upgrading](https://mikro-orm.io/docs/7.0/upgrading)
This is documentation for MikroORM **7.0** , which is no longer actively maintained.
For up-to-date documentation, see the **[latest version](https://mikro-orm.io/docs/quick-start)** (7.1).
Version: 7.0
On this page
# Quick Start
In this guide, you will learn how to quickly bootstrap a simple project using MikroORM. For a deeper dive, check out the [Getting Started guide](https://mikro-orm.io/docs/7.0/guide) which follows.
> If you prefer to take a peek at an existing project, there are [several example repositories](https://mikro-orm.io/docs/7.0/examples) available.
## Installation[​](https://mikro-orm.io/docs/7.0/quick-start#installation "Direct link to Installation")
First install the module via package manager of your choice. Do not forget to install the database driver as well:
  * npm
  * Yarn
  * pnpm
...
> 
```
You can read more about all the possible configuration options in [Advanced Configuration](https://mikro-orm.io/docs/7.0/configuration) section.
## Entity Discovery[​](https://mikro-orm.io/docs/7.0/quick-start#entity-discovery "Direct link to Entity Discovery")
You can provide entities directly or use folder-based discovery with glob patterns:
```
const orm = await MikroORM.init({  
  // explicit entity references (recommended)  
...
```
If you are experiencing problems with folder-based discovery, try using `mikro-orm debug` CLI command to check what paths are actually being used.
For detailed information about using decorators (legacy and ES spec) and metadata providers, see the [Using Decorators guide](https://mikro-orm.io/docs/7.0/using-decorators). For glob-based entity discovery, see [Folder-based Discovery](https://mikro-orm.io/docs/7.0/folder-based-discovery).
## Synchronous initialization[​](https://mikro-orm.io/docs/7.0/quick-start#synchronous-initialization "Direct link to Synchronous initialization")
As opposed to the async [`MikroORM.init`](https://mikro-orm.io/api/core/class/MikroORM#init) method, you can prefer to use synchronous variant with the constructor: [`new MikroORM()`](https://mikro-orm.io/api/core/class/MikroORM#constructor).
```
const orm = new MikroORM({ ... });  
```
This method has some limitations:
  ...
  * ORM extensions are not auto-loaded
  * when metadata cache is enabled, `FileCacheAdapter` needs to be explicitly set in the config
## RequestContext helper[​](https://mikro-orm.io/docs/7.0/quick-start#requestcontext-helper "Direct link to RequestContext helper")
Now you will need to fork entity manager for each request so their [identity maps](https://mikro-orm.io/identity-map/) will not collide. To do so, use the `RequestContext` helper:
```
const app = express();  
...
```
> You should register this middleware as the last one just before request handlers and before any of your custom middleware that is using the ORM. There might be issues when you register it before request processing middleware like `queryParser` or `bodyParser`, so definitely register the context after them.
More info about `RequestContext` is described [here](https://mikro-orm.io/docs/7.0/identity-map#request-context).
## Entity definition[​](https://mikro-orm.io/docs/7.0/quick-start#entity-definition "Direct link to Entity definition")
Now you can start defining your entities. MikroORM supports multiple approaches:
  * defineEntity + class
  * defineEntity
  * decorators
...
export type IBook = InferEntity<typeof Book>;  
```
Decorators require additional setup - see the [Using Decorators guide](https://mikro-orm.io/docs/7.0/using-decorators) for configuration details:
./entities/Book.ts
```
import { Collection } from '@mikro-orm/core';  
import { Entity, PrimaryKey, Property, ManyToOne, ManyToMany } from '@mikro-orm/decorators/legacy';  
...
```
For UUID primary keys, use `p.uuid()` with `defineEntity`, `@PrimaryKey({ type: 'uuid' })` with decorators, or `{ type: 'uuid', primary: true }` with `EntitySchema`.
More information can be found in the [Defining Entities section](https://mikro-orm.io/docs/7.0/defining-entities) in docs.
## EntityManager[​](https://mikro-orm.io/docs/7.0/quick-start#entitymanager "Direct link to EntityManager")
When you have your entities defined, you can start using ORM via `EntityManager`.
To save entity state to database, you need to persist it. Persist determines whether to use `insert` or `update` and computes appropriate change-set. Entity references that are not persisted yet (does not have identifier) will be cascade persisted automatically.
```
// use em.create() to create entity instances  
...
```
Take a look at docs about [working with `EntityManager`](https://mikro-orm.io/docs/7.0/entity-manager).
## Setting up the Commandline Tool[​](https://mikro-orm.io/docs/7.0/quick-start#setting-up-the-commandline-tool "Direct link to Setting up the Commandline Tool")
MikroORM ships with a number of command line tools that are very helpful during development, like `SchemaGenerator` and `EntityGenerator`. You can call this command from the NPM binary directory or use `npx`:
```
# install the CLI package first!  
$ yarn add --dev @mikro-orm/cli  
...
$ npx mikro-orm debug --config ./my-config.ts  
```
Your configuration file may export multiple configuration objects in an array. The different configurations must have a `contextName` in them. If no `contextName` is specified, it is treated as the name "default". You can use the `MIKRO_ORM_CONTEXT_NAME` environment variable or the `--contextName` command line option to pick a configuration with a particular `contextName` to use for the CLI. See [below](https://mikro-orm.io/docs/7.0/quick-start#configuration-file-structure) for details on the config object.
All available commands are listed in the CLI help:
```
$ npx mikro-orm  
...
```
To verify your setup, you can use `mikro-orm debug` command.
## Configuration file structure[​](https://mikro-orm.io/docs/7.0/quick-start#configuration-file-structure "Direct link to Configuration file structure")
Preferred way of creating to the configuration object is with the `defineConfig` helper. It will provide intellisense even in JavaScript files, without the need for type hints via jsdoc:
```
import { defineConfig } from '@mikro-orm/sqlite';  
...
```
which will let you run the "demo" database with "app" user whenever you do not specify `MIKRO_ORM_CONTEXT_NAME` or the `--contextName` option in CLI. Specifying "super" for the name will run the "demo" database with the "admin" user, specifying "use:example1" will load the "tenant_example1" database with the "app" user, and specifying "edit:example1" will load the "tenant_example1" database with the "admin" user.
[](https://github.com/mikro-orm/mikro-orm/edit/master/docs/versioned_docs/version-7.0/quick-start.md)
Last updated on **Mar 20, 2026** by **Martin Adámek**
[Next Getting Started Guide](https://mikro-orm.io/docs/7.0/guide)
  * [Installation](https://mikro-orm.io/docs/7.0/quick-start#installation)
  * [Entity Discovery](https://mikro-orm.io/docs/7.0/quick-start#entity-discovery)
  * [Synchronous initialization](https://mikro-orm.io/docs/7.0/quick-start#synchronous-initialization)
  * [RequestContext helper](https://mikro-orm.io/docs/7.0/quick-start#requestcontext-helper)
  * [Entity definition](https://mikro-orm.io/docs/7.0/quick-start#entity-definition)
  * [EntityManager](https://mikro-orm.io/docs/7.0/quick-start#entitymanager)
  * [Setting up the Commandline Tool](https://mikro-orm.io/docs/7.0/quick-start#setting-up-the-commandline-tool)
  * [Configuration file structure](https://mikro-orm.io/docs/7.0/quick-start#configuration-file-structure)
#### Docs
  * [Quick Start](https://mikro-orm.io/docs/quick-start)
  * [Getting Started](https://mikro-orm.io/docs/guide)
  * [Migration from v6 to v7](https://mikro-orm.io/docs/upgrading-v6-to-v7)
...
[latest: v7.1.3](https://mikro-orm.io/versions)[Discord](https://discord.gg/w8bjxFHS7X "Chat on Discord")[GitHub](https://github.com/mikro-orm/mikro-orm "View on GitHub")[Twitter](https://twitter.com/MikroORM "Twitter")
Search`Ctrl``K`
  * [Overview](https://mikro-orm.io/docs/5.9/quick-start)
